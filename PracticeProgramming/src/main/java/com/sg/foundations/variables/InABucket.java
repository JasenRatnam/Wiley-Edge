...
public class InABucket {
     public static void main(String[] args) {
        ...
        System.out.println("My pet walrus weights " + weightOfTeacupPig + " Kg");
         System.out.println("I have " +  grainsOfSand + "grains of sand in my pocket");
    }
}
