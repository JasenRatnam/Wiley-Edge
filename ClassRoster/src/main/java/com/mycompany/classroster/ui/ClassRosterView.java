 ...
 * all views to user is handled here
 * @author Jasen
 */
public class ClassRosterView {
    ...
    public int printMenuAndGetSelection() {
        ...
        io.print("5. Add a quiz score for a Student");
        io.print("6. View quiz scores for a Student");
        io.print("7. View average quiz score for a Student");
        io.print("8. Exit");
    ...
    //display result of student removal
