...
public class ClassRosterDaoFileImplTest {
     ...
     * created a new blank testroster.txt file using the FileWriter, 
     * used when instantiating our testDao
     * ensuring that we are starting with a fresh, empty Dao object, 
     * @throws Exception 
     */
    @BeforeEach
    ...
    /**
     * We know that the DAO is in an empty state since we created a new empty 
     * instance within our setUp method.
     * 
     * create a new Student object (Arrange)
     * we add that Student to the DAO (Act)
     * we get the Student back out of the DAO and put it in another variable (Act)
     * we check to see that the data within the stored Student is equal to the 
     * retrieved Student from the DAO (Assert).
     * @throws Exception 
     */
    @Test
    ...
    /**
     * testing the two methods addStudent and getAllStudents and verifying each
     * method works
     * 
