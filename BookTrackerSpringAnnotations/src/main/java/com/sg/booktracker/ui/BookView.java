...
public class BookView {
    ...
    /**
     * @Autowired before constructor
     * Qhen a BookView is created, look for something that is-a UserIO to inject. 
     * UserIOConsoleImpl class will be in memory and available to inject due to annotation
     * @param io 
     * can be placed directly on the io field above if no constructor
     */
    @Autowired
