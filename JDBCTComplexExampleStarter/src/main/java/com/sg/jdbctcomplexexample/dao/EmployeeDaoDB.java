...
public class EmployeeDaoDB implements EmployeeDao {
    ...
    public Employee getEmployeeById(int id) {
        // Throws an Exception if nothing is found from the query.
        try {
            ...
            //return null to indicate that Employee was not found in the database.
            return null;
        }
    }  
    ...
    public Employee addEmployee(Employee employee) {
        ...
        //get the ID of the Employee that was just inserted in the database.
    ...
    public void deleteEmployeeById(int id) {
        ...
        //start by deleting the bridge table entries between Employee and Meeting.
